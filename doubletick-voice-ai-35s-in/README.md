# DoubleTick Voice AI — Instant Calling for Launch Leads — India cut (9:16)
...
| Frame rate | 30 fps |
| Output | MP4 / H.264 (`renders/doubletick-voice-ai-35s-in-9x16.mp4`) |
...
npx hyperframes render -o renders/doubletick-voice-ai-35s-in-9x16.mp4 -f 30 -q delivery
```
...
Read runs ~180 wpm. Voice: Kokoro-82M `af_heart`; override
...
Identical to the UAE cut in structure, timing, layout, colour, motion and voice.
Only the market-specific strings change, in the visuals and in the narration:

| UAE cut | India cut |
| --- | --- |
| "In UAE real estate, slow follow-ups…" (VO + subtitle) | "In Indian real estate, slow follow-ups…" |
| Ahmed R. / AR | Rohit S. / RS |
| Fatima S., Rohan M. | Ananya K., Karthik R. |
| Dubai Marina Residence | Emerald Heights, Whitefield |
| 2 Bedroom | 3 BHK |
| +971 50 662 4417 | +91 98450 31702 |
| AED 3.5M | ₹3.5 Cr |
| AED 3–4M | ₹2.5–3.5 Cr |

Only line 2 of the voice-over changed, so it was the only one re-synthesised;
the other four stems are bit-identical to the UAE cut. "Indian" reads 0.27s
faster than the spelled-out "U. A. E.", so `a-vo2` is now 6.09s and the two
subtitle cues inside that line shift accordingly. Every scene window,
animation, cut and the 35.0s runtime are untouched — the saved time simply
lands as a slightly longer beat before line 3.
