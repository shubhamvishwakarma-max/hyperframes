...
| Scene | Time | Beat |
|---|---|---|
| 01 Executive hook | 0.0–6.6 | Scale vs. Personalization? → volume card (24,580 leads) and rep card join via a green connector → PERSONALIZATION × SCALE |
| 02 AI-powered rep experience | 6.6–13.8 | Connector grows into Deepak's conversation; AI Agent panel ticks Intent → Team size → Enterprise → Qualification; PROSPECT → HOT LEAD |
